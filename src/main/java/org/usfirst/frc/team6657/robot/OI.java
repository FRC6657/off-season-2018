...
public class OI {
	...
	private Button ladderUp;
	private Button ladderDown;
	private Button clawOpen;
	private Button clawClose;
	...
	public boolean isXbox() {
		return DriverStation.getInstance().getJoystickIsXbox(RobotMap.driveControllerID);
	}
}
